...
XLM_PRETRAINED_MODEL_ARCHIVE_MAP = {
    ...
    'xlm-mlm-enfr-1024': "/Users/bemuller/Documents/Work/INRIA/dev/representation/lm/xlm/xlm-mlm-enfr-1024-pytorch_model.bin",
...
class XLMModel(XLMPreTrainedModel):
    ...
    def forward(self, input_ids, attention_mask=None, langs=None, token_type_ids=None, position_ids=None,
        ...
        # WARNING : hardcoding the use of land FR LANG
        langs = self.config.lang2id["fr"]*torch.ones((tensor.size(0), tensor.size(1)), dtype=torch.long)
        if tensor.is_cuda:
            langs = langs.cuda()
        ...
        # WARNING : only returning outpus to fit in BertMultitask
        return outputs[0], None  # outputs, (hidden_states), (attentions)
