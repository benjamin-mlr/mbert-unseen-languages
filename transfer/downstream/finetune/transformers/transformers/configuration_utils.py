...
class PretrainedConfig(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.output_hidden_states_per_head = kwargs.pop('output_hidden_states_per_head', False)

        self.output_past = kwargs.pop('output_past', True)  # Not used by all models
        self.torchscript = kwargs.pop('torchscript', False)  # Only used by PyTorch models
        self.use_bfloat16 = kwargs.pop('use_bfloat16', False)
        self.pruned_heads = kwargs.pop('pruned_heads', {})
        self.hard_skip_all_layers = kwargs.pop('hard_skip_all_layers', [])
        self.hard_skip_attention_layers = kwargs.pop('hard_skip_attention_layers', [])
        self.hard_skip_dense_layers = kwargs.pop('hard_skip_dense_layers ', [])
